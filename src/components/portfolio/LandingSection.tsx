    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="text-center z-10 max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <div className="w-px h-16 bg-gradient-to-b from-accent/50 to-transparent relative">
            <div className="absolute top-0 w-1 h-1 bg-accent rounded-full animate-bounce" />
          </div>
        </div>
      </div>
